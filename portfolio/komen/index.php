...
<html>
<head>
    <title>Komen's iamthecure.org Case Study</title>
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="chrome=1">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="Komen's iamthecure.org case study on LeonGaban.com">
    <meta name="keywords" content="komen, iamthecure.org, flash development, web design, web development, web designer, web developer, portfolio">
    <meta name="author" content="Leon Gaban">

	<meta property="og:image" content="../../images/leon_gaban.png"/>
	<meta property="og:title" content="Komen's iamthecure.org | Flash development by Leon Gaban"/>
...
<body>
    ...
    <div class="outer" id="showcase-komen">
        <div class="inner">
            ...
            <header id="case-header">
                ...
                <div id="case-h1h2">
                    <h1>Komen's iamthecure.org</h1>
                    <h2>Work performed: Flash Development</h2>
                </div>

                <div id="view-more-button">
                    <input onclick="window.open('http://leongaban.com/portfolio/komen/iamthecure/')" class="view-more-button" type="submit" value="View Original Work">
                </div>
            </header>
            ...
            <div class="pattern">
                ...
                <div class="showcase-nav">
                    ...
                    <div class="next-showcase">
                        <a href="../sony"><div class="showcase-btn" id="btn-next">Next &rarr;</div></a>
                        <div class="showcase-btn-shadow"></div>
                    </div>
                </div>

                <div class="showcase-thumbs">
                    <div class="first"><img src="../../images/komen1.jpg"/></div>
                    <div class="second"><img src="../../images/komen2.jpg"/></div>
                    <div class="third"><img src="../../images/komen3.jpg"/></div>
                </div>
        ...
        <section id="case-study">
            ...
            <h1>Flash Development for Komen's IAmTheCure.org</h1>

            <div id="case-study-description">
                <p>
                    Komen's <a href="http://iamthecure.org" title="I am the cure" target="_blank">iamthecure.org</a> was my first major project at <a href="http://touchstorm" title="Touchstorm" target="_blank">Touchstorm.</a> The original website featured a flash intro and several other flash based interactive widgets. For example, one for recording and uploading user ‘chants’ (build in Actionscript 2 and the Red 5 server) and a photo uploader.
                </p>
                <p>
                    The web has changed a lot since 2007 and the current website has been mostly redone, this link is to a saved version of the site I worked on.
                </p>
            </div><!-- #case-study-description -->

            <div id="case-study-extra">
                <a href="http://leongaban.com/portfolio/komen/iamthecure/gallery.html" title="The original Athena's Web site" target="_blank"><img src="../../images/extra_komen.jpg"/></a>
                <span>The Original Chant and Frames of Life Gallery</span>
            </div>
        ...
        <section id="technology">
            ...
            <h1>Technology used on iamthecure.org</h1>
            ...
            <div id="case-container">
                ...
                <div id="skills">
                    <ul>
                        ...
                        <li>Red 5 server integration</li>
                    </ul>
                    <ul>
